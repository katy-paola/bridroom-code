...
export default async function ProfileEdit() {
  ...
  return (
    <section className="mt-14 flex w-full flex-col items-center gap-8 p-4 xs:p-8 sm:px-44 md:mt-16 md:px-72 lg:flex-row lg:items-center lg:gap-16 lg:px-36 lg:py-10 xl:px-60">
