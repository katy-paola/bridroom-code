...
export default function SearchSection() {
  return (
    <section className="relative flex flex-col items-center gap-8 bg-neutral-main-bg px-4 pb-8 pt-2 xs:px-8 sm:justify-center sm:px-12 md:px-28 md:pt-4 lg:items-start lg:gap-16 lg:px-36 lg:py-20 xl:px-60">
